# CC-Teams Excellence Decision Log
...
1. Full benchmark corpus executed for CC10x baseline and CC-Teams candidate.
...
- **Date:** 2026-02-09
- **Phase:** A
- **Title:** Start CC-Teams Excellence Program with quality-only scope
- **Owner:** @rom.iluz
- **Scope:** `docs/cc-teams-excellence/*`
...
- **Evidence:** `docs/cc-teams-excellence/MASTER-PLAN.md`
...
- **Decision:** Do not require runtime hooks for CC-Teams core orchestration.
...
- **Owner:** @rom.iluz
- **Scope:** `scripts/eval/*`, `scripts/lint-cc-teams-protocol-integrity.sh`, `package.json`, excellence docs
- **Context:** Phase D required reproducible scoring artifacts and stronger protocol regression checks before prod merge.
- **Decision:** Implement benchmark scaffold and score scripts, add protocol-integrity lint, and wire all checks under `npm run check:cc-teams`.
...
- **Evidence:** `scripts/eval/run-benchmark.sh`, `scripts/eval/score-benchmark.sh`, `scripts/lint-cc-teams-protocol-integrity.sh`, `package.json`.
...
- **Owner:** @rom.iluz
- **Scope:** `archive/2026-02-11-post-launch-docs/docs/cc-teams-excellence/BORROW-STRATEGY-NEURAL-HARMONY.md`, `docs/cc-teams-excellence/MASTER-PLAN.md`
...
- **Evidence:** `archive/2026-02-11-post-launch-docs/docs/cc-teams-excellence/BORROW-STRATEGY-NEURAL-HARMONY.md`, `docs/cc-teams-excellence/MASTER-PLAN.md`.
- **Follow-ups:** Execute S1 first, validate with `npm run check:cc-teams`, then progress sequentially.
...
- **Owner:** @rom.iluz
- **Scope:** `plugins/cc-teams/skills/cc-teams-lead/SKILL.md`, `docs/cc-teams-excellence/EXPECTED-BEHAVIOR-RUNBOOK.md`, `scripts/lint-cc-teams-protocol-integrity.sh`
...
- **Evidence:** Updated S1 runtime and validation docs + successful `npm run check:cc-teams`.
...
- **Owner:** @rom.iluz
- **Scope:** `plugins/cc-teams/skills/cc-teams-lead/SKILL.md`, `docs/cc-teams-excellence/EXPECTED-BEHAVIOR-RUNBOOK.md`, `docs/cc-teams-excellence/BENCHMARK-CASES.md`, `scripts/lint-cc-teams-protocol-integrity.sh`
...
- **Evidence:** S2 runtime + runbook + benchmark + lint updates and successful `npm run check:cc-teams`.
...
- **Owner:** @rom.iluz
- **Scope:** `docs/cc-teams-excellence/PRODUCTION-READINESS-SYSTEM.md`, `docs/cc-teams-excellence/MASTER-PLAN.md`
...
- **Owner:** @rom.iluz
- **Scope:** `plugins/cc-teams/skills/cc-teams-lead/SKILL.md`, `docs/cc-teams-excellence/EXPECTED-BEHAVIOR-RUNBOOK.md`, `scripts/lint-cc-teams-protocol-integrity.sh`, `docs/cc-teams-excellence/MASTER-PLAN.md`
- **Context:** Need higher throughput for bounded low-risk BUILD work while preventing over-engineering and preserving CC-Teams quality guarantees.
...
- **Evidence:** S3 runtime + runbook + lint + plan updates and successful `npm run check:cc-teams`.
...
- **Owner:** @rom.iluz
- **Scope:** `docs/cc-teams-excellence/EXPECTED-BEHAVIOR-RUNBOOK.md`, `scripts/lint-cc-teams-protocol-integrity.sh`
...
- **Evidence:** S4 runbook/lint updates and successful `npm run check:cc-teams`.
...
- **Evidence:** Lead protocol update + runbook S18 scenario + lint enforcement + successful `npm run check:cc-teams`.
...
- **Decision:** Require project-scoped team names (`cc-teams-{project_key}-{workflow}-{timestamp}`) and restrict stale-team cleanup to current project scope only.
...
- **Evidence:** Lead protocol + runbook S19 + lint enforcement + successful `npm run check:cc-teams`.
...
- **Owner:** @rom.iluz
- **Scope:** `docs/cc-teams-excellence/PHASE-E-VERDICT.md`
...
- **Evidence:** `docs/cc-teams-excellence/PHASE-E-VERDICT.md`
...
- **Owner:** @rom.iluz
- **Scope:** `docs/cc-teams-excellence/PHASE-E-VERDICT.md`, `docs/cc-teams-excellence/MASTER-PLAN.md`, `docs/cc-teams-excellence/PRODUCTION-READINESS-SYSTEM.md`
- **Context:** CC-Teams is live in production; governance docs must reflect launch state and post-launch change policy.
...
- **Evidence:** Production publication event + passing protocol checks (`npm run check:cc-teams`) + updated Phase E verdict file.
...
- **Owner:** @rom.iluz
- **Scope:** `plugins/cc-teams/skills/router-contract/SKILL.md`, `plugins/cc-teams/skills/cc-teams-lead/SKILL.md`, `plugins/cc-teams/agents/*.md`, `scripts/lint-cc-teams-artifact-policy.sh`, `docs/cc-teams-excellence/EXPECTED-BEHAVIOR-RUNBOOK.md`, `docs/functional-governance/protocol-manifest.md`
...
- **Evidence:** Updated runtime prompts/skills + runbook/protocol docs + successful `npm run check:cc-teams`.
- **Follow-ups:** Validate in live BUILD/DEBUG runs that missing/mismatched claims reliably route to `CC-TEAMS REM-EVIDENCE`.
