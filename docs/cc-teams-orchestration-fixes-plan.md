# CC-Teams Orchestration Fixes Plan
...
1. **Only functional files** - Changes only to `plugins/cc-teams/skills/` and `plugins/cc-teams/agents/`
...
|---|------|--------|----------|
| 1.1 | REM-FIX assignee not explicit | Orphan remediation task | cc-teams-lead lines 1039-1053 |
| 1.2 | TeamDelete failure recovery incomplete | Zombie workflow | cc-teams-lead lines 1486-1500 |
| 1.3 | Reviewer conflict priority incomplete | Inconsistent decisions | cc-teams-lead lines 1290-1318 |
| 1.4 | Contract-diff checkpoint undefined | Skip verification | cc-teams-lead lines 1314-1317 |
| 1.5 | Shutdown rejection handling vague | Shutdown loop | cc-teams-lead lines 1491 |

### MEDIUM PRIORITY (Clarity Improvements)

| # | Flaw | Impact | Location |
|---|------|--------|----------|
| 2.1 | Challenge round termination unclear | Potential hang | cc-teams-lead lines 1305-1308 |
...
| 2.4 | Memory Notes preservation undefined | Data loss risk | cc-teams-lead lines 277-308 |
| 2.5 | Orphan task "treat cautiously" vague | Ambiguous action | cc-teams-lead line 274 |
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` lines 1039-1053

**Current**:
```
→ TaskCreate({
    subject: "CC-TEAMS REM-FIX: {teammate_name}",
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` lines 1486-1500
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` around line 544 (task description) and lines 1290-1318
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` lines 1314-1317
...
5. Before invoking verifier, run a contract-diff checkpoint:
   ...
   - If mismatch exists, create `CC-TEAMS REM-FIX:` task and block verifier
```
...
5. Before invoking verifier, run a contract-diff checkpoint:
   ...
   - If any mismatch: create `CC-TEAMS REM-FIX: Contract-diff failure` and block verifier
```
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` line 1491
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` lines 1305-1308
...
**Location**: `plugins/cc-teams/skills/bug-court/SKILL.md` line 133
...
**Location**: `plugins/cc-teams/skills/pair-build/SKILL.md` line 126
...
**Timeout handling:** If live-reviewer remains unresponsive after 2 nudges, builder applies escalation ladder from cc-teams-lead (MEDIUM at T+5, HIGH at T+8, CRITICAL at T+10).
```

**POST-CHECK**: Verify escalation ladder section exists in cc-teams-lead
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` lines 277-308
...
**Location**: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md` line 274
...
**Location**: `plugins/cc-teams/skills/bug-court/SKILL.md` lines 137-151
...
- [ ] `docs/functional-governance/cc-teams-bible-functional.md` - update if behavior changed
- [ ] `docs/cc-teams-excellence/EXPECTED-BEHAVIOR-RUNBOOK.md` - update examples if needed
