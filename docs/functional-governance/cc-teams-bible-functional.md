...
Source: `plugins/cc-teams/skills/cc-teams-lead/SKILL.md:786`
...
- Every workflow includes a `CC-TEAMS Memory Update` task.
...
Source: `plugins/cc-teams/skills/pair-build/SKILL.md:190`
...
Source: `plugins/cc-teams/skills/session-memory/SKILL.md:538`
